...
const NFTCard = ({ nftItem, title, listings }) => {
  ...
  const [price, setPrice] = useState(0) //default value is 0

  //when new NFT is listed useEffect is invoked, and price is set
  useEffect(() => {
    ...
    >
      ...
      <div className={style.details}>
        <div className={style.info}>
          ...
          {/* if item is listed price is shown */}
          {isListed && (
        ...
        {/* heart symbol to ltell no. of likes */}
